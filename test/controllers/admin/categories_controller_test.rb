  ...
  test "should create admin_category" do
    assert_difference('Admin::Category.count') do
      post :create, admin_category: {
                      body_id: @admin_category.body_id,
                      date: @admin_category.date,
                      date_visible: @admin_category.date_visible,
                      default_body_id: @admin_category.default_body_id,
                      description: @admin_category.description,
                      display_name: @admin_category.display_name,
                      lock_version: @admin_category.lock_version,
                      meta_id: @admin_category.meta_id,
                      status: @admin_category.status,
                      tree_type: @admin_category.tree_type,
                      url_name: @admin_category.url_name
                  }
    end

    assert_redirected_to edit_admin_category_path(assigns(:admin_category))
  end
